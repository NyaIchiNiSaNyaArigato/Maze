...
# Game characters:
# Change the packman's class from GameSprite to Player 
# Change the monster's class from GameSprite to Enemy
...
w4 = Wall(154, 205, 50, 360, 100, 10, 340)
w5 = Wall(154, 205, 50, 400, 90, 10, 330)
w6 = Wall(154, 205, 50, 400, 400, 10, 75)
w7 = Wall(154, 205, 50, 400, 900, 10, 75)
 
game = True
finish = False              # ADD THIS VARIABLE
clock = time.Clock()
FPS = 60

font.init()
font = font.SysFont('comicsansms', 70)
